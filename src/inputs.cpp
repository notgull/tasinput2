...
Inputs::Inputs(uint32_t raw_val) {
  this->d = Directional(get_bit(raw_val, 3), get_bit(raw_val, 2),
                        get_bit(raw_val, 1), get_bit(raw_val, 0));
  this->start = get_bit(raw_val, 4);
  this->z = get_bit(raw_val, 5);
  this->b = get_bit(raw_val, 6);
  this->a = get_bit(raw_val, 7);
  this->c = Directional(get_bit(raw_val, 11), get_bit(raw_val, 10),
                        get_bit(raw_val, 9), get_bit(raw_val, 8));
